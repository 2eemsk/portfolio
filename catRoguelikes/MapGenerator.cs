...
public class MapGenerator : MonoBehaviour
{
    ...
    public void MapCollocate() //맵타일생성
    {
        //시작맵 배치 
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            if (IsValidMapCoordinate(endX, endY) && !x_raw[endX].y_raw[endY]._isCheck)
            {
                ...
                portalList.Add(x_raw[endX].y_raw[endY]._mapObj.transform.GetChild(4).gameObject);
    ...
    public void InitializeMapTiles() //맵타일 초기화
    {
        //print("초기화 시작");
